...
public class vertical_stepper_adapter extends Fragment implements IStepperAdapter {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_vertical_stepper_adapter, container, false);
    }
